				       ...
				       struct sdw_bpt_msg *msg)
{
	...
	ret = hda_sdw_bpt_open(cdns->dev->parent /* PCI device */ , sdw->instance,
			       &sdw->bpt_ctx.bpt_tx_stream, &sdw->bpt_ctx.dmab_tx_bdl,
			       pdi0_buffer_size, tx_dma_bandwidth, &sdw->bpt_ctx.bpt_rx_stream,
	...
	ret1 = hda_sdw_bpt_close(cdns->dev->parent /* PCI device */ , sdw->bpt_ctx.bpt_tx_stream,
