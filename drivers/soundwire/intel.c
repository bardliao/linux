...
static int intel_master_startup(struct sdw_intel *sdw)
{
...
static void intel_master_remove(struct platform_device *pdev)
{
	struct device *dev = *pdev->dev;
	struct sdw_intel *sdw;
...
static struct platform_driver intel_master_drv = {
	.platform_drv = {
		.driver = {
...
module_platform_driver(intel_master_drv);
