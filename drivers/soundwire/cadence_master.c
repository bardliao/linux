...
static void cdns_init_clock_ctrl(struct sdw_cdns *cdns)
{
	...
	/*
	 * Frame shap and bus->params.curr_dr_freq could be updated by sdw_compute_bus_params()
	 * Clock is set to max_clk_freq, so that we need to update frame shape according to the
