...
EXPORT_SYMBOL_NS(hda_dma_prepare, "SND_SOC_SOF_INTEL_HDA_COMMON");

int hda_dma_cleanup(struct device *dev, struct snd_dma_buffer *dmab,
...
EXPORT_SYMBOL_NS(hda_dma_cleanup, "SND_SOC_SOF_INTEL_HDA_COMMON");
