...
struct cs42l43_codec {
	...
	const struct cs42l43_pll_config *pll_config;
	struct completion pll_ready;
	// Lock to protect PLL settings
...
int cs42l43_sdw_add_slave(struct snd_pcm_substream *substream,
			  struct snd_pcm_hw_params *params, struct snd_soc_dai *dai);
int cs42l43_sdw_remove_slave(struct snd_pcm_substream *substream,
			     struct snd_soc_dai *dai);
int cs42l43_sdw_set_stream(struct snd_soc_dai *dai, void *sdw_stream, int direction);
#else
static inline int cs42l43_sdw_add_slave(struct snd_pcm_substream *substream,
					struct snd_pcm_hw_params *params,
					struct snd_soc_dai *dai)
{
	return -EINVAL;
}
#define cs42l43_sdw_remove_slave NULL
